...
| T1-GFX-01 | B2/B3 | B2: `engine/abi-tests/contract.c`; B3: `Tests/FrameKitTests/*`; composition: `Tests/EngineKitTests/EngineKitTests.swift` | M1 solid BMP | M2 C-IPAD | M0–M2 | contract-green |
...
| T1-IN-01 | B2/B4 | B2: `engine/abi-tests/contract.c` (`mrdpd_stub_script_mouse`); B4: `Tests/InputKitTests/*`; composition: `Tests/EngineKitTests/EngineKitTests.swift` | M3 sequence | — | M0/M3 | contract-green |
